...
\end{itemize}
To provide an easy maintainable shared \gls{dto} of objects to be used in REST requests, we use \textit{OpenAPI Specification}. In addition, the backend uses \gls{k8s} for user management and game server deployments.
%TODO PNG ????
